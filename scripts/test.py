...
nsf = NavBySceneFamiliarity(landscape, (40, 1), 2.0, sensor_pixel_dimensions = [2, 8], n_test_angles = 20, n_sensor_levels = 8,
                            max_distance_to_training_path = 80, saccade_degrees = 90, sensor_real_area = (14., "$\mathrm{mm}$"))
